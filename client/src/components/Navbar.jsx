          ...
          {isAuthenticated ? (
            <div className="pt-4 pb-3 border-t border-gray-700">
              ...
              <div className="space-y-1">
                <Link
                  to="/settings"
                  className="flex items-center px-4 py-3 text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 transition-colors"
                >
                ...
                <button
                  onClick={handleLogout}
                  className="w-full text-left flex items-center px-4 py-3 text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 transition-colors"
                >
